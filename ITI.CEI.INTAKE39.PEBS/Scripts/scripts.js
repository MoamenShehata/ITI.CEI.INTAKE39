...
var viewer = document.getElementById("WebGL");
...
//var myPhotoMaterial = NewTexturedMaterial('myPhoto.png');
...
var project_span = 25;
var project_height = 7;
var project_length = 40;
var project_slope = 0.1;

var project_span_min = 25;
var project_span_max = 30;

var project_height_min = 7;
var project_height_max = 8;

var project_length_min = 40;
var project_length_max = 45;
...
var planex = CreateCube(2, 0.0, .05, blueMaterial);
var planez = CreateCube(.05, 0, 2, greenMaterial);
var planey = CreateCube(.05, 2, 0, redMaterial);

//var sliderContainer = CreatePlaneByPosition(.1, 1, whiteMaterial, Math.PI / 2, 0, 0, 1, 0, 1);
//var slider = CreatePlaneByPosition(.1, .3, materialSlider, Math.PI / 2, 0, 0, 1, 0.0005, 1);
...
//#region deleted
//heb600 = new IBeamColumn(project_height, .3, .03, .54, .015, project_span / 2, 0);
//heb600.DrawGeometry(scene);

//heb601 = new IBeamColumn(project_height, .3, .03, .54, .015, -(project_span / 2), 0);
//heb601.DrawGeometry(scene);
//#endregion
...
function EditProjectSpan(newSpan) {
	//heb600.Instance.position.x = newSpan / 2;
	//heb601.Instance.position.x = (newSpan / 2) * -1;
...
function EditProjectHeight(newHeight) {
	if (newHeight >= project_height_min && newHeight <= project_height_max) {
		//heb600.SetHeight(newHeight);
		//heb601.SetHeight(newHeight);
